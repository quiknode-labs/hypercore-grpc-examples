...
func (StreamType) Descriptor() protoreflect.EnumDescriptor {
	return file_hyperliquid_proto_enumTypes[0].Descriptor()
}

func (StreamType) Type() protoreflect.EnumType {
	return &file_hyperliquid_proto_enumTypes[0]
}
...
func (x *StreamSubscribe) GetStartBlock() uint64 {
	if x != nil {
		return x.StartBlock
	}
	return 0
...
const file_hyperliquid_proto_rawDesc = "" +
	"\n" +
	"\x11hyperliquid.proto\x12\vhyperliquid\"\x8a\x01\n" +
	...
	"\fStreamBlocks\x12\x16.hyperliquid.Timestamp\x1a\x12.hyperliquid.Block0\x01b\x06proto3"
...
func file_hyperliquid_proto_init() {
	...
	file_hyperliquid_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_hyperliquid_proto_enumTypes,
